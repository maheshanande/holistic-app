export const poseInstructions = {
    ...
    Namaste: [
        'Begin standing at the centre of the mat, with feet a few inches apart for better support and balance, and join the palms in Namaste placing them at the centre of the chest in Mountain Pose Namaste',
        "Begin slow breathing and with awareness go on up to 8 breaths, watching the flow of energy into the body. Make sure the breathing is not too fast and jerky.",
        "Close your eyes if possible and stay connected to the breath calming the body simultaneously.",
