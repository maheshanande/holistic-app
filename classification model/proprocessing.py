...
images_in_folder = os.path.join('./classification model/yoga_poses', 'train')
csvs_out_path = './classification model/train_data.csv'
...
images_in_folder = os.path.join('./classification model/yoga_poses', 'test')
csvs_out_path = './classification model/test_data.csv'
